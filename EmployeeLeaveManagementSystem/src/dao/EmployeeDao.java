...
public class EmployeeDao {
    ...
    public boolean addEmployee(Employee employee) {
        ...
        String sql = "INSERT INTO employees(employee_name,email,department,joining_date) VALUES(?,?,?,?)";
    ...
    public void viewAllEmployees() {
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                System.out.println("Joining    : " + rs.getDate("joining_date"));
                System.out.println("---------------------------------------------");
            }
    ...
    public boolean updateEmployee(Employee employee) {
        ...
        String sql = "UPDATE employees SET employee_name=?, email=?, department=?, joining_date=? WHERE employee_id=?";
